...
func (t *TokenPayloadModel1_0_0_rc1) MarshalCBOR(w io.Writer) error {
	...
	if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("/ucan/assert/receipt"))); err != nil {
		return err
	}
	if _, err := cw.WriteString(string("/ucan/assert/receipt")); err != nil {
		return err
	}
	...
	// t.Args (datamodel.ArgsModel) (struct)
	if len("args") > 8192 {
...
func (t *SigPayloadModel) MarshalCBOR(w io.Writer) error {
	...
	if t.TokenPayload1_0_0_rc1 != nil {
		...
		if len("ucan/rcpt@1.0.0-rc.1") > 8192 {
			return xerrors.Errorf("Value in field \"ucan/rcpt@1.0.0-rc.1\" was too long")
		}

		if err := cw.WriteMajorTypeHeader(cbg.MajTextString, uint64(len("ucan/rcpt@1.0.0-rc.1"))); err != nil {
			return err
		}
		if _, err := cw.WriteString(string("ucan/rcpt@1.0.0-rc.1")); err != nil {
			return err
		}
