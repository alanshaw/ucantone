...
func (t *TaskModel) MarshalDagJSON(w io.Writer) error {
	...
	if err := jw.WriteString(string("sub")); err != nil {
		return fmt.Errorf("writing string for field \"sub\": %w", err)
	}
	if err := jw.WriteObjectColon(); err != nil {
		return err
	}
...
func (t *TaskModel) UnmarshalDagJSON(r io.Reader) (err error) {
	*t = TaskModel{}
	...
	if err := jr.ReadObjectOpen(); err != nil {
		return fmt.Errorf("reading object open for TaskModel: %w", err)
	}
	close, err := jr.PeekObjectClose()
	if err != nil {
		return fmt.Errorf("peeking object close for TaskModel: %w", err)
	}
	if close {
		if err := jr.ReadObjectClose(); err != nil {
			return fmt.Errorf("reading object close for TaskModel: %w", err)
		}
	} else {
		for i := uint64(0); i < 8192; i++ {
			...
			if err != nil {
				if errors.Is(err, jsg.ErrLimitExceeded) {
					return fmt.Errorf("reading string for field TaskModel: string too large")
				}
				return fmt.Errorf("reading string for field TaskModel: %w", err)
			}
			if err := jr.ReadObjectColon(); err != nil {
				return fmt.Errorf("reading object colon for field TaskModel: %w", err)
			}
			switch name {
			...
			default:
				...
				if err := jr.DiscardType(); err != nil {
					return fmt.Errorf("ignoring field %s for TaskModel: %w", name, err)
				}
			}

			close, err := jr.ReadObjectCloseOrComma()
			if err != nil {
				return fmt.Errorf("reading object close or comma for field TaskModel: %w", err)
			}
			if close {
				break
			}
			if i == 8192-1 {
				return fmt.Errorf("map too large for TaskModel")
			}
		}
	}
...
func (t *TokenPayloadModel1_0_0_rc1) MarshalDagJSON(w io.Writer) error {
	...
	if t.Exp == nil {
		if err := jw.WriteNull(); err != nil {
			return fmt.Errorf("writing null for field t.Exp: %w", err)
		}
	} else {
		if err := jw.WriteInt64(int64(*t.Exp)); err != nil {
			return fmt.Errorf("writing int64 for field t.Exp: %w", err)
		}
	}
	...
	if t.Iat != nil {
		...
		if err := jw.WriteString(string("iat")); err != nil {
			return fmt.Errorf("writing string for field \"iat\": %w", err)
		}
		if err := jw.WriteObjectColon(); err != nil {
			return err
		}
		...
		if t.Iat == nil {
			if err := jw.WriteNull(); err != nil {
				return fmt.Errorf("writing null for field t.Iat: %w", err)
			}
		} else {
			if err := jw.WriteInt64(int64(*t.Iat)); err != nil {
				return fmt.Errorf("writing int64 for field t.Iat: %w", err)
			}
		}
	...
	if t.Meta != nil {
		...
		if err := jw.WriteString(string("meta")); err != nil {
			return fmt.Errorf("writing string for field \"meta\": %w", err)
		}
		if err := jw.WriteObjectColon(); err != nil {
			return err
		}
	...
	if err := jw.WriteString(string("prf")); err != nil {
		return fmt.Errorf("writing string for field \"prf\": %w", err)
	}
	if err := jw.WriteObjectColon(); err != nil {
		return err
	}
	...
	if err := jw.WriteArrayOpen(); err != nil {
		return fmt.Errorf("writing array open for field t.Prf: %w", err)
	}
	for i, v := range t.Prf {
		if i > 0 {
			if err := jw.WriteComma(); err != nil {
				return fmt.Errorf("writing comma for field t.Prf: %w", err)
			}
		}
...
func (t *TokenPayloadModel1_0_0_rc1) UnmarshalDagJSON(r io.Reader) (err error) {
	*t = TokenPayloadModel1_0_0_rc1{}
	...
	if err := jr.ReadObjectOpen(); err != nil {
		return fmt.Errorf("reading object open for TokenPayloadModel1_0_0_rc1: %w", err)
	}
	close, err := jr.PeekObjectClose()
	if err != nil {
		return fmt.Errorf("peeking object close for TokenPayloadModel1_0_0_rc1: %w", err)
	}
	if close {
		if err := jr.ReadObjectClose(); err != nil {
			return fmt.Errorf("reading object close for TokenPayloadModel1_0_0_rc1: %w", err)
		}
	} else {
		for i := uint64(0); i < 8192; i++ {
			name, err := jr.ReadString(8192)
			if err != nil {
				if errors.Is(err, jsg.ErrLimitExceeded) {
					return fmt.Errorf("reading string for field TokenPayloadModel1_0_0_rc1: string too large")
				}
				return fmt.Errorf("reading string for field TokenPayloadModel1_0_0_rc1: %w", err)
			}
			if err := jr.ReadObjectColon(); err != nil {
				return fmt.Errorf("reading object colon for field TokenPayloadModel1_0_0_rc1: %w", err)
			}
			switch name {
			...
			case "aud":

				{
					...
					if err != nil {
						return fmt.Errorf("peeking null for field t.Aud: %w", err)
					}
					if null {
						if err := jr.ReadNull(); err != nil {
							return fmt.Errorf("reading null for field t.Aud: %w", err)
						}
					} else {
						t.Aud = new(did.DID)
			...
			case "exp":
				{
					...
					if err != nil {
						return fmt.Errorf("reading int64 or null for field t.Exp: %w", err)
					}
					if nval != nil {
			...
			case "iat":
				{
					...
					nval, err := jr.ReadNumberAsInt64OrNull()
					if err != nil {
						return fmt.Errorf("reading int64 or null for field t.Iat: %w", err)
					}
					if nval != nil {
						typed := ucan.UnixTimestamp(*nval)
						t.Iat = &typed
			...
			case "meta":

				{
					null, err := jr.PeekNull()
					if err != nil {
						return fmt.Errorf("peeking null for field t.Meta: %w", err)
					}
					if null {
						if err := jr.ReadNull(); err != nil {
							return fmt.Errorf("reading null for field t.Meta: %w", err)
						}
					} else {
			...
			case "prf":
				{
					...
					if err := jr.ReadArrayOpen(); err != nil {
						return fmt.Errorf("reading array open for field t.Prf: %w", err)
					}

					close, err := jr.PeekArrayClose()
					if err != nil {
						return fmt.Errorf("peeking array close for field t.Prf: %w", err)
					}
					if close {
						if err := jr.ReadArrayClose(); err != nil {
							return fmt.Errorf("reading array close for field t.Prf: %w", err)
						}
						...
						for i := 0; i < 8192; i++ {
							...
							if err != nil {
								return fmt.Errorf("reading array close or comma for field t.Prf: %w", err)
							}
							if close {
								break
							}
							if i == 8192-1 {
								return fmt.Errorf("reading array for field t.Prf: slice too large")
							}
						}
					}
			...
			default:
				// Field doesn't exist on this type, so ignore it
				if err := jr.DiscardType(); err != nil {
					return fmt.Errorf("ignoring field %s for TokenPayloadModel1_0_0_rc1: %w", name, err)
				}
			}

			close, err := jr.ReadObjectCloseOrComma()
			if err != nil {
				return fmt.Errorf("reading object close or comma for field TokenPayloadModel1_0_0_rc1: %w", err)
			}
			if close {
				break
			}
			if i == 8192-1 {
				return fmt.Errorf("map too large for TokenPayloadModel1_0_0_rc1")
			}
		}
	}
...
func (t *SigPayloadModel) MarshalDagJSON(w io.Writer) error {
	...
	if err := jw.WriteString(string("h")); err != nil {
		return fmt.Errorf("writing string for field \"h\": %w", err)
	}
	if err := jw.WriteObjectColon(); err != nil {
		return err
	}
	...
	if t.TokenPayload1_0_0_rc1 != nil {
		...
		if err := jw.WriteString(string("ucan/inv@1.0.0-rc.1")); err != nil {
			return fmt.Errorf("writing string for field \"ucan/inv@1.0.0-rc.1\": %w", err)
		}
		if err := jw.WriteObjectColon(); err != nil {
			return err
		}
...
func (t *SigPayloadModel) UnmarshalDagJSON(r io.Reader) (err error) {
	*t = SigPayloadModel{}
	...
	if err := jr.ReadObjectOpen(); err != nil {
		return fmt.Errorf("reading object open for SigPayloadModel: %w", err)
	}
	close, err := jr.PeekObjectClose()
	if err != nil {
		return fmt.Errorf("peeking object close for SigPayloadModel: %w", err)
	}
	if close {
		if err := jr.ReadObjectClose(); err != nil {
			return fmt.Errorf("reading object close for SigPayloadModel: %w", err)
		}
	} else {
		for i := uint64(0); i < 8192; i++ {
			name, err := jr.ReadString(8192)
			if err != nil {
				if errors.Is(err, jsg.ErrLimitExceeded) {
					return fmt.Errorf("reading string for field SigPayloadModel: string too large")
				}
				return fmt.Errorf("reading string for field SigPayloadModel: %w", err)
			}
			if err := jr.ReadObjectColon(); err != nil {
				return fmt.Errorf("reading object colon for field SigPayloadModel: %w", err)
			}
			switch name {
			...
			case "h":

				{
					...
					if err != nil {
						if errors.Is(err, jsg.ErrLimitExceeded) {
							return fmt.Errorf("reading bytes for field t.Header: byte array too large")
						}
						return fmt.Errorf("reading bytes for field t.Header: %w", err)
					}
					if len(bval) > 0 {
						t.Header = []uint8(bval)
					}
			...
			case "ucan/inv@1.0.0-rc.1":

				{
					null, err := jr.PeekNull()
					if err != nil {
						return fmt.Errorf("peeking null for field t.TokenPayload1_0_0_rc1: %w", err)
					}
					if null {
						if err := jr.ReadNull(); err != nil {
							return fmt.Errorf("reading null for field t.TokenPayload1_0_0_rc1: %w", err)
						}
					} else {
			...
			default:
				// Field doesn't exist on this type, so ignore it
				if err := jr.DiscardType(); err != nil {
					return fmt.Errorf("ignoring field %s for SigPayloadModel: %w", name, err)
				}
			}

			close, err := jr.ReadObjectCloseOrComma()
			if err != nil {
				return fmt.Errorf("reading object close or comma for field SigPayloadModel: %w", err)
			}
			if close {
				break
			}
			if i == 8192-1 {
				return fmt.Errorf("map too large for SigPayloadModel")
			}
		}
	}
