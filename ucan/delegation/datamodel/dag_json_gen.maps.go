...
func (t *TokenPayloadModel1_0_0_rc1) MarshalDagJSON(w io.Writer) error {
	...
	if t.Nbf != nil {
		...
		if err := jw.WriteString(string("nbf")); err != nil {
			return fmt.Errorf("writing string for field \"nbf\": %w", err)
		}
		if err := jw.WriteObjectColon(); err != nil {
			return err
		}
		...
		if t.Nbf == nil {
			if err := jw.WriteNull(); err != nil {
				return fmt.Errorf("writing null for field t.Nbf: %w", err)
			}
		} else {
			if err := jw.WriteInt64(int64(*t.Nbf)); err != nil {
				return fmt.Errorf("writing int64 for field t.Nbf: %w", err)
			}
		}
	...
	if err := jw.WriteString(string("pol")); err != nil {
		return fmt.Errorf("writing string for field \"pol\": %w", err)
	}
	if err := jw.WriteObjectColon(); err != nil {
		return err
	}
	if err := t.Pol.MarshalDagJSON(jw); err != nil {
		return fmt.Errorf("marshaling field t.Pol: %w", err)
	}
	written++
	if written > 0 {
		if err := jw.WriteComma(); err != nil {
			...
			case "nbf":
				{
					...
					nval, err := jr.ReadNumberAsInt64OrNull()
					if err != nil {
						return fmt.Errorf("reading int64 or null for field t.Nbf: %w", err)
					}
					if nval != nil {
						typed := ucan.UnixTimestamp(*nval)
						t.Nbf = &typed
...
func (t *SigPayloadModel) MarshalDagJSON(w io.Writer) error {
	...
	if t.TokenPayload1_0_0_rc1 != nil {
		...
		if err := jw.WriteString(string("ucan/dlg@1.0.0-rc.1")); err != nil {
			return fmt.Errorf("writing string for field \"ucan/dlg@1.0.0-rc.1\": %w", err)
		}
		if err := jw.WriteObjectColon(); err != nil {
			return err
		}
